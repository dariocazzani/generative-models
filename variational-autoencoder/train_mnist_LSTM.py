...
def decoder(z, inputs=None, reuse=False):
    ...
    with tf.variable_scope('Decoder'):
        ...
        with tf.variable_scope('layer_1'):
            ...
            output_1, state_1 = lstm_cell_1(first_input, initial_state_1)

        with tf.variable_scope('layer_2'):
            initial_state_2 = (expanded_z_2, expanded_z_2)
            output_2, state_2 = lstm_cell_2(output_1, initial_state_2)
        ...
        for i in range(input_dim-1):
            ...
            if inputs:
                with tf.variable_scope('layer_1'):
                    output_1, state_1 = lstm_cell_1(inputs[i], state_1)
                with tf.variable_scope('layer_2'):
                    output_2, state_2 = lstm_cell_2(output_1, state_2)
            else:
                with tf.variable_scope('layer_1'):
                    output_1, state_1 = lstm_cell_1(output_2, state_1)
                with tf.variable_scope('layer_2'):
                    output_2, state_2 = lstm_cell_2(output_1, state_2)
            outputs.append(output_2)
